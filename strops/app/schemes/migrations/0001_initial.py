...
import strops.app.utils.fields
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('symbol', strops.app.utils.fields.SympyField(encoder='symbol', help_text='Symbol representing this parameter.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modified', models.DateTimeField(auto_now=True, help_text='Date the class was last modified')),
                ('tag', models.CharField(blank=True, help_text='User defined tag for easy searches', max_length=200, null=True)),
                ('factor', strops.app.utils.fields.SympyField(encoder='expression', help_text="Factor associated with the propagation of scales. E.g., 'source -> factor * target' at 'order'.")),
