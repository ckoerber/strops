...
ROOT_URLCONF = "strops.app.config.urls"
...
WSGI_APPLICATION = "strops.app.config.wsgi.application"
...
STATICFILES_DIRS = [
    os.path.join(ROOT_DIR, "strops", "app", "static"),
...
MIGRATION_MODULES = {"notifications": "strops.app.config.migrations.notifications"}
