    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('matrix1', strops.app.utils.fields.SympyField(encoder='non-commutative-expression', help_text='Term representing the operator. For example $\\gamma_5$', unique=True)),
