...
ROOT_URLCONF = "opdb.app.config.urls"
...
WSGI_APPLICATION = "opdb.app.config.wsgi.application"
...
MIGRATION_MODULES = {"notifications": "opdb.app.config.migrations.notifications"}
